...
# patch visualizer
# sed -i 's|"/ws"|"'${SIMCORE_NODE_BASEPATH}'/ws"|' /opt/paraview/share/paraview-5.6/web/visualizer/www"${SIMCORE_NODE_BASEPATH}"/Visualizer.js
# sed -i 's|"https"===window.location.protocol|window.location.protocol.startsWith("https")|' /opt/paraview/share/paraview-5.6/web/visualizer/www"${SIMCORE_NODE_BASEPATH}"/Visualizer.js
# sed -i 's|"/paraview/"|"'${SIMCORE_NODE_BASEPATH}'/paraview/"|' /opt/paraview/share/paraview-5.6/web/visualizer/www"${SIMCORE_NODE_BASEPATH}"/Visualizer.js
