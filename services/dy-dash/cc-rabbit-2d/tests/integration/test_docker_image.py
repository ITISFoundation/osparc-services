...
def docker_image_key(docker_client: docker.DockerClient) -> str:
    ...
    image_key = "{}/cc-2d-viewer:{}".format(registry, tag)
...
def osparc_service_labels_jsonschema(tmp_path) -> Dict:
    url = "https://github.com/ITISFoundation/osparc-simcore/blob/36fdb7b39dd581a05b513992a6a2f0ea2ce200f4/api/specs/common/schemas/node-meta-v0.0.1.json"
